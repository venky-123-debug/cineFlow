...
export default function MoviesPage() {
  ...
  return (
    <div className="min-h-screen text-white flex flex-col relative overflow-hidden">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[700px] h-[350px] bg-[radial-gradient(circle_at_top,_var(--tw-gradient-stops))] from-rose-500/15 via-transparent to-transparent blur-3xl pointer-events-none -z-10"></div>
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-6 py-8 relative z-10">
        ...
        <div className="relative rounded-3xl overflow-hidden mb-10 h-[280px] bg-gradient-to-r from-rose-950/40 via-zinc-900/60 to-zinc-950 border border-zinc-800/80 flex items-center p-8 md:p-12 shadow-[0_15px_30px_-10px_rgba(244,63,94,0.1)]">
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,_var(--tw-gradient-stops))] from-rose-500/10 via-transparent to-transparent"></div>
          
          {/* Virtual projection light rays effect in CSS */}
          ...
          <div className="max-w-xl relative z-10">
            ...
            <h2 className="text-3xl md:text-4xl font-black mt-4 leading-tight text-zinc-100 drop-shadow-[0_2px_8px_rgba(0,0,0,0.5)]">
              ...
              Secure the Best Seats in <span className="text-rose-500 text-gradient-rose drop-shadow-sm font-black">{selectedCity}</span>!
            </h2>
            <p className="text-zinc-400 mt-3 text-xs md:text-sm leading-relaxed max-w-md font-medium">
              Explore blockbusters, regional cinema, and independent releases with seamless online seat selection.
            </p>
          </div>
        </div>
        ...
        {loading ? (
          <div className="flex-1 flex flex-col items-center justify-center py-24">
            ...
            <span className="text-zinc-400 mt-6 text-xs font-bold uppercase tracking-wider">Discovering movies...</span>
          </div>
        ) : error ? (
          ...
          <div className="text-center py-20 border border-dashed border-zinc-800 rounded-2xl bg-zinc-900/10">
            <svg className="w-12 h-12 text-zinc-700 mx-auto mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <p className="text-zinc-400 text-sm font-medium">No movies scheduled in {selectedCity} matching your search.</p>
            <button
                ...
                <div className="aspect-[2/3] w-full bg-zinc-950 relative overflow-hidden">
                  {movie.banner ? (
                    ...
                    <div className="w-full h-full flex flex-col items-center justify-center p-6 bg-gradient-to-br from-zinc-900 to-zinc-950 text-center">
                      <svg className="w-10 h-10 text-rose-500/20 mb-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M7 4v16M17 4v16M3 8h4m10 0h4M3 12h18M3 16h4m10 0h4M4 20h16a1 1 0 001-1V5a1 1 0 00-1-1H4a1 1 0 00-1 1v14a1 1 0 001 1z"></path>
                      </svg>
                      <span className="text-xs font-black text-zinc-400 px-2">{movie.title}</span>
                    </div>
                  )}
                    ...
                    {movie.genre && movie.genre.length > 0 && (
                      <div className="flex flex-wrap gap-1 mt-3">
                        {movie.genre.slice(0, 3).map((g) => (
                          <span key={g} className="text-[9px] px-2 py-0.5 rounded bg-zinc-900 border border-zinc-800 text-zinc-400 font-bold uppercase tracking-wider">
                            {g}
                          </span>
                        ))}
                      </div>
